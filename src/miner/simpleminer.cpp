...
//   const command_line::arg_descriptor<uint32_t> arg_mining_threads = { "mining-threads", "Specify mining threads count", 1, command_line::flag_t::not_use_default };
//   const command_line::arg_descriptor<std::string, true> arg_scratchpad_url = { "remote_scratchpad", "Specify URL to remote scratchpad"};
//   const command_line::arg_descriptor<std::string> arg_scratchpad_local = { "local_scratchpad", "Specify URL to remote scratchpad ", "", command_line::flag_t::not_use_default };
// 
