...
namespace tools
{
  namespace error
  {
    ...
    //----------------------------------------------------------------------------------------------------
    struct genesis_mismatch : public wallet_rpc_error
    {
      explicit genesis_mismatch(std::string&& loc, const std::string& request)
      : wallet_rpc_error(std::move(loc), "genesis mismatch", request) {}
    };
    //----------------------------------------------------------------------------------------------------
...
#define THROW_IF_TRUE_WALLET_ONLY_THROW(cond, err_type, mess)                                                                     \
  if (cond)                                                                                                                       \
  {                                                                                                                               \
    throw err_type("", mess);                                 \
  }
