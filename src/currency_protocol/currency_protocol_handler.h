...
DISABLE_CHANNEL_BY_DEFAULT("currency_protocol", "Currency protocol default channel.")
...
namespace currency
{
  ...
  public:
    ...
    void log_connections(std::ostream &s);
    void log_connections_history(std::ostream &s);
  ...
  private:
    ...
    void log_connection(std::ostream &s, nodetool::peerid_type peer_id, const connection_context &context);
