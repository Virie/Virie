...
namespace currency
{
  ...
  public:
    ...
    bool run();
    void stop();
    bool is_rpc_mode() const { return m_rpc_mode; }
    bool was_opened() const { return m_was_opened; }
    bool is_offline_mode() const { return m_offline_mode; }
    currency::account_public_address get_miner_address() const { return m_miner_address; }

    tools::wallet2 *get_wallet() const { return m_wallet.get(); }
  ...
  private:
    ...
    bool restore_wallet(const std::string &wallet_file, const std::string& password, const std::string& brain_wallet, bool watch_only = false);
    bool close_wallet();
    ...
    bool print_brain_wallet(const std::vector<std::string> &args = std::vector<std::string>());
    bool print_spend_key(const std::vector<std::string> &args = std::vector<std::string>());
    bool print_view_key(const std::vector<std::string> &args = std::vector<std::string>());
    bool print_info(const std::vector<std::string> &args = std::vector<std::string>());
    bool sign_transfer(const std::vector<std::string> &args);
    bool submit_transfer(const std::vector<std::string> &args);
    bool stat_transfers(const std::vector<std::string> &args);
    bool locked_transfers(const std::vector<std::string> &args);
  ...
  private:
    ...
    std::string m_restore_wo_wallet;
    std::string m_import_path;
    currency::account_public_address m_miner_address;
