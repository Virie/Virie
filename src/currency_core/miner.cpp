...
namespace currency
{
  ...
  namespace
  {
    ...
    const command_line::arg_descriptor<std::string>   arg_block_template_extra_text = { "miner_text_info", "Set block extra text info", "", command_line::flag_t::not_use_default };
  }
