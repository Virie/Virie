...
namespace tools
{
  ...
  bool get_transfer_address_cb(const std::string& adr_str, currency::account_public_address& addr, currency::bc_payment_id& payment_id, callback_t cb)
  {
    if (!adr_str.size())
      return false;
  ...
  inline 
  bool get_transfer_address(const std::string& adr_str, currency::account_public_address& addr, currency::bc_payment_id& payment_id, i_core_proxy* proxy)
  {
