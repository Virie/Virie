...
namespace currency
{
  ...
  typedef bool fill_block_template_func_t(block &bl, bool pos, size_t median_size, uint64_t already_generated_coins,
    size_t &total_size, uint64_t &fee, uint64_t height);
  ...
  struct create_block_template_params
  {
    ...
    bool pos = false;
    pos_entry pe;
    fill_block_template_func_t* p_custom_fill_block_template_func;
  };
