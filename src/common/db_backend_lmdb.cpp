...
DISABLE_CHANNEL_BY_DEFAULT("lmdb", "LMDB default channel.")
...
namespace tools
{
  namespace db
  {
    namespace
    {
      static const bool set_ver = deps_version::add_lib_version(tools::db::lmdb_db_backend::get_version());
    }
    ...
    std::pair<std::string, std::string> lmdb_db_backend::get_version()
    {
