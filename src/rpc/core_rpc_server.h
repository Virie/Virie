...
ENABLE_CHANNEL_BY_DEFAULT("rpc", "RPC server default channel.")
...
namespace currency
{
  ...
  public:
    ...
    bool on_get_static_info(const COMMAND_RPC_GET_STATIC_INFO::request& req, COMMAND_RPC_GET_STATIC_INFO::response& res, connection_context& cntx);
    ...
    BEGIN_URI_MAP2()
      ...
      MAP_URI_AUTO_JON2("/getstaticinfo",             on_get_static_info,             COMMAND_RPC_GET_STATIC_INFO)
      // binary RPCs
      ...
      BEGIN_JSON_RPC_MAP("/json_rpc")
        ...
        MAP_JON_RPC   ("getstaticinfo",               on_get_static_info,             COMMAND_RPC_GET_STATIC_INFO)
