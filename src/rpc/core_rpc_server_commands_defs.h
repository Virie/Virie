...
#define CORE_RPC_PROTOCOL_VERSION 1
...
#pragma pack(pop)
  ...
  struct COMMAND_RPC_GET_STATIC_INFO
  {
    struct request
    {
      BEGIN_KV_SERIALIZE_MAP()
    ...
    struct response
    {
      ...
      BEGIN_KV_SERIALIZE_MAP()
        KV_SERIALIZE_CONST_VAL(version, PROJECT_VERSION_LONG)
        KV_SERIALIZE_CONST_VAL(rpc_version, CORE_RPC_PROTOCOL_VERSION)
#ifdef TESTNET
        KV_SERIALIZE_CONST_VAL(test_name, CURRENCY_NAME_SHORT)
#endif
      END_KV_SERIALIZE_MAP()
    };
...
#define COMMAND_RPC_GET_INFO_FLAG_ALL_FLAGS                      0xffffffffffffffffLL
  ...
  struct COMMAND_RPC_GET_INFO
  {
    ...
    struct response
    {
      ...
      BEGIN_KV_SERIALIZE_MAP()
        ...
        KV_SERIALIZE(unavailable_disk_space)

#ifdef TESTNET
      KV_SERIALIZE_EPHEMERAL_N(std::string, [](const response&) -> std::string {return CURRENCY_NAME_SHORT;}, "test_net")
#endif
  ...
  struct tx_rpc_extended_info
  {
    ...
    BEGIN_KV_SERIALIZE_MAP()
      ...
      KV_SERIALIZE_SAVE_LOAD(payment_id)
    END_KV_SERIALIZE_MAP()
  };
