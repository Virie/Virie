...
export class BlockchainComponent implements OnInit, OnDestroy {
  ...
  getTxPoolDetailsSubscription: Subscription;
  ...
  refreshPool() {
    if (this.getTxPoolDetailsSubscription) {
      this.getTxPoolDetailsSubscription.unsubscribe();
    }
    this.getTxPoolDetailsSubscription = this.httpService.getTxPoolDetails(this.poolLimit).subscribe(
      data => {
  ...
  onChange() {
    ...
    if (this.info) {
      ...
      if (this.lastSendBlockDetail.start !== this.listBlockStart || this.lastSendBlockDetail.limit !== this.limit) {
        ...
        this.loader = true;
        this.getBlockDetailsSubscription = this.httpService.getBlockDetails(this.listBlockStart, this.limit).subscribe(
          data => {
