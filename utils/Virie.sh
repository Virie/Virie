...
out_file_name=~/.local/share/applications/Virie.desktop
...
create_desktop_icon()
{
    ...
    echo Name=Virie | tee -a $target_file_name > /dev/null
    echo GenericName=Virie | tee -a $target_file_name  > /dev/null
    ...
    echo Exec=$script_dir/Virie | tee -a $target_file_name  > /dev/null
