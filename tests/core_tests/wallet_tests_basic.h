...
protected:
  ...
  struct params_check_balance
  {
    params_check_balance(size_t account_index = 0,
      ...
      : total_balance(total_balance), unlocked_balance(unlocked_balance), mined_balance(mined_balance), awaiting_in(awaiting_in), awaiting_out(awaiting_out), account_index(account_index) {}
