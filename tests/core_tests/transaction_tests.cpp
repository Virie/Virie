...
bool test_block_creation()
{
  ...
  bool r = get_account_address_from_str(adr, "HgBGCZTVFVA3uaeQx1Tyi7Vz1StYcWofGF3seFfiduzwadHcj4ha7PGgLwgHzVbzmTV1vpEbDnpuaUF6CAcvwkM8GstFX5R");
...
{
  CHECK_AND_ASSERT_MES(test_transaction_generation_and_ring_signature(), false, "failed test_transaction_generation_and_ring_signature");
  CHECK_AND_ASSERT_MES(test_block_creation(), false, "failed test_block_creation");
  CHECK_AND_ASSERT_MES(test_example_key_derivation(), false, "failed test_example_key_derivation");
